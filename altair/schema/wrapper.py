...
class AggregatedFieldDef(SchemaBase):
    ...
    def __init__(self, field, op, **kwds):
        # make certain required properties with invalid identifiers are in kwds
        missing_kwds = {'as'} - set(kwds)
        if missing_kwds:
            raise TypeError('missing required keyword arguments: {0}'.format(missing_kwds))
        
        # additionalProperties=False, so make sure kwds only contains recognized properties
        unrecognized_kwds = set(kwds) - {'as'}
        if unrecognized_kwds:
            raise TypeError('unexpected keyword arguments {0}').format(unrecognized_kwds)
...
class BinTransform(SchemaBase):
    ...
    def __init__(self, bin, field, **kwds):
        # make certain required properties with invalid identifiers are in kwds
        missing_kwds = {'as'} - set(kwds)
        if missing_kwds:
            raise TypeError('missing required keyword arguments: {0}'.format(missing_kwds))
...
class CalculateTransform(SchemaBase):
    ...
    def __init__(self, calculate, **kwds):
        # make certain required properties with invalid identifiers are in kwds
        missing_kwds = {'as'} - set(kwds)
        if missing_kwds:
            raise TypeError('missing required keyword arguments: {0}'.format(missing_kwds))
...
class InterpolateParams(SchemaBase):
    ...
    __schema = {'$ref': '#/definitions/InterpolateParams', 'definitions': Root._Root__schema['definitions']}
...
class LogicalAndPredicate(SchemaBase):
    ...
    def __init__(self, **kwds):
        # make certain required properties with invalid identifiers are in kwds
        missing_kwds = {'and'} - set(kwds)
        if missing_kwds:
            raise TypeError('missing required keyword arguments: {0}'.format(missing_kwds))
        
        # additionalProperties=False, so make sure kwds only contains recognized properties
        unrecognized_kwds = set(kwds) - {'and'}
        if unrecognized_kwds:
            raise TypeError('unexpected keyword arguments {0}').format(unrecognized_kwds)
...
class LogicalNotPredicate(SchemaBase):
    ...
    def __init__(self, **kwds):
        # make certain required properties with invalid identifiers are in kwds
        missing_kwds = {'not'} - set(kwds)
        if missing_kwds:
            raise TypeError('missing required keyword arguments: {0}'.format(missing_kwds))
        
        # additionalProperties=False, so make sure kwds only contains recognized properties
        unrecognized_kwds = set(kwds) - {'not'}
        if unrecognized_kwds:
            raise TypeError('unexpected keyword arguments {0}').format(unrecognized_kwds)
...
class LogicalOrPredicate(SchemaBase):
    ...
    def __init__(self, **kwds):
        # make certain required properties with invalid identifiers are in kwds
        missing_kwds = {'or'} - set(kwds)
        if missing_kwds:
            raise TypeError('missing required keyword arguments: {0}'.format(missing_kwds))
        
        # additionalProperties=False, so make sure kwds only contains recognized properties
        unrecognized_kwds = set(kwds) - {'or'}
        if unrecognized_kwds:
            raise TypeError('unexpected keyword arguments {0}').format(unrecognized_kwds)
...
class LookupTransform(SchemaBase):
    ...
    def __init__(self, lookup, default=Undefined, **kwds):
        # make certain required properties with invalid identifiers are in kwds
        missing_kwds = {'from'} - set(kwds)
        if missing_kwds:
            raise TypeError('missing required keyword arguments: {0}'.format(missing_kwds))
        
        # additionalProperties=False, so make sure kwds only contains recognized properties
        unrecognized_kwds = set(kwds) - {'from', 'as'}
        if unrecognized_kwds:
            raise TypeError('unexpected keyword arguments {0}').format(unrecognized_kwds)
...
class TimeUnitTransform(SchemaBase):
    ...
    def __init__(self, field, timeUnit, **kwds):
        # make certain required properties with invalid identifiers are in kwds
        missing_kwds = {'as'} - set(kwds)
        if missing_kwds:
            raise TypeError('missing required keyword arguments: {0}'.format(missing_kwds))
...
class TopLevelFacetedUnitSpec(SchemaBase):
    ...
    def __init__(self, encoding, mark, autosize=Undefined, background=Undefined, config=Undefined, data=Undefined, description=Undefined, height=Undefined, name=Undefined, padding=Undefined, projection=Undefined, selection=Undefined, title=Undefined, transform=Undefined, width=Undefined, **kwds):
        # additionalProperties=False, so make sure kwds only contains recognized properties
        unrecognized_kwds = set(kwds) - {'$schema'}
        if unrecognized_kwds:
            raise TypeError('unexpected keyword arguments {0}').format(unrecognized_kwds)
        
        super(TopLevelFacetedUnitSpec, self).__init__(encoding=encoding, mark=mark, autosize=autosize, background=background, config=config, data=data, description=description, height=height, name=name, padding=padding, projection=projection, selection=selection, title=title, transform=transform, width=width, **kwds)
...
class TopLevelFacetSpec(SchemaBase):
    ...
    def __init__(self, facet, spec, autosize=Undefined, background=Undefined, config=Undefined, data=Undefined, description=Undefined, name=Undefined, padding=Undefined, resolve=Undefined, title=Undefined, transform=Undefined, **kwds):
        # additionalProperties=False, so make sure kwds only contains recognized properties
        unrecognized_kwds = set(kwds) - {'$schema'}
        if unrecognized_kwds:
            raise TypeError('unexpected keyword arguments {0}').format(unrecognized_kwds)
...
class TopLevelHConcatSpec(SchemaBase):
    ...
    def __init__(self, hconcat, autosize=Undefined, background=Undefined, config=Undefined, data=Undefined, description=Undefined, name=Undefined, padding=Undefined, resolve=Undefined, title=Undefined, transform=Undefined, **kwds):
        # additionalProperties=False, so make sure kwds only contains recognized properties
        unrecognized_kwds = set(kwds) - {'$schema'}
        if unrecognized_kwds:
            raise TypeError('unexpected keyword arguments {0}').format(unrecognized_kwds)
...
class TopLevelLayerSpec(SchemaBase):
    ...
    def __init__(self, layer, autosize=Undefined, background=Undefined, config=Undefined, data=Undefined, description=Undefined, height=Undefined, name=Undefined, padding=Undefined, resolve=Undefined, title=Undefined, transform=Undefined, width=Undefined, **kwds):
        # additionalProperties=False, so make sure kwds only contains recognized properties
        unrecognized_kwds = set(kwds) - {'$schema'}
        if unrecognized_kwds:
            raise TypeError('unexpected keyword arguments {0}').format(unrecognized_kwds)
...
class TopLevelRepeatSpec(SchemaBase):
    ...
    def __init__(self, repeat, spec, autosize=Undefined, background=Undefined, config=Undefined, data=Undefined, description=Undefined, name=Undefined, padding=Undefined, resolve=Undefined, title=Undefined, transform=Undefined, **kwds):
        # additionalProperties=False, so make sure kwds only contains recognized properties
        unrecognized_kwds = set(kwds) - {'$schema'}
        if unrecognized_kwds:
            raise TypeError('unexpected keyword arguments {0}').format(unrecognized_kwds)
...
class TopLevelVConcatSpec(SchemaBase):
    ...
    def __init__(self, vconcat, autosize=Undefined, background=Undefined, config=Undefined, data=Undefined, description=Undefined, name=Undefined, padding=Undefined, resolve=Undefined, title=Undefined, transform=Undefined, **kwds):
        # additionalProperties=False, so make sure kwds only contains recognized properties
        unrecognized_kwds = set(kwds) - {'$schema'}
        if unrecognized_kwds:
            raise TypeError('unexpected keyword arguments {0}').format(unrecognized_kwds)
