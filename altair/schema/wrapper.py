...
class CompositeUnitSpec(SchemaBase):
    ...
    def __init__(self, encoding=Undefined, mark=Undefined, data=Undefined, description=Undefined, height=Undefined, name=Undefined, projection=Undefined, selection=Undefined, title=Undefined, transform=Undefined, width=Undefined, **kwds):
        super(CompositeUnitSpec, self).__init__(encoding=encoding, mark=mark, data=data, description=description, height=height, name=name, projection=projection, selection=selection, title=title, transform=transform, width=width, **kwds)
...
class CompositeUnitSpecAlias(SchemaBase):
    ...
    def __init__(self, encoding=Undefined, mark=Undefined, data=Undefined, description=Undefined, height=Undefined, name=Undefined, projection=Undefined, selection=Undefined, title=Undefined, transform=Undefined, width=Undefined, **kwds):
        super(CompositeUnitSpecAlias, self).__init__(encoding=encoding, mark=mark, data=data, description=description, height=height, name=name, projection=projection, selection=selection, title=title, transform=transform, width=width, **kwds)
...
class FacetedCompositeUnitSpecAlias(SchemaBase):
    ...
    def __init__(self, encoding=Undefined, mark=Undefined, data=Undefined, description=Undefined, height=Undefined, name=Undefined, projection=Undefined, selection=Undefined, title=Undefined, transform=Undefined, width=Undefined, **kwds):
        super(FacetedCompositeUnitSpecAlias, self).__init__(encoding=encoding, mark=mark, data=data, description=description, height=height, name=name, projection=projection, selection=selection, title=title, transform=transform, width=width, **kwds)
...
class InterpolateParams(SchemaBase):
    ...
    def __init__(self, type=Undefined, gamma=Undefined, **kwds):
        super(InterpolateParams, self).__init__(type=type, gamma=gamma, **kwds)
...
class TopLevelFacetedUnitSpec(SchemaBase):
    ...
    def __init__(self, encoding=Undefined, mark=Undefined, autosize=Undefined, background=Undefined, config=Undefined, data=Undefined, description=Undefined, height=Undefined, name=Undefined, padding=Undefined, projection=Undefined, selection=Undefined, title=Undefined, transform=Undefined, width=Undefined, **kwds):
